...
public class NotificationChannelSerializer {
  ...
  public static Bundle toBundle(NotificationChannel channel) {
    ...
    result.putString(LIGHT_COLOR_KEY, String.format("#%08x", Color.valueOf(channel.getLightColor()).toArgb()));
    ...
    result.putString(SOUND_URI_KEY, channel.getSound().toString());
